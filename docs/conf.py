...
html_context = {
    ...
    'announcement_message': "This site is NOT the official <i>Write the Docs</i> website and is and is </br> only used as the knowledge hub for Paion Data dev team. </br> The official <i>Write the Docs</i> website is at <a href='https://www.writethedocs.org/'>writethedocs.org</a>",
}
