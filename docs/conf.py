...
html_context = {
    ...
    'announcement_message': "This site (writethedocs.paion-data.dev) is NOT the official <i>Write the Docs website</i> and is used as the Knowledge Hub of Paion Data dev team. The official <i>Write the Docs website</i> website is at <a href='https://www.writethedocs.org/'>writethedocs.org</a>",
}
